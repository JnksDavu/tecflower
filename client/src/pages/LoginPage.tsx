          ...
          <div className="w-full max-w-md space-y-8">
            <div className="space-y-5 text-center lg:text-left">
              ...
              <div className="space-y-2">
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#8f79cb]">Area de login</p>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <label className="flex items-center gap-3 rounded-2xl border border-[#efe8fb] bg-[#fcfaff] px-4 py-3 text-sm text-[#6c5a88]">
                <input type="checkbox" className="h-4 w-4 rounded border-[#cbb7f1] text-[#6f3fe4] focus:ring-[#b89cff]" />
                Manter sessao ativa neste dispositivo
              </label>
              <button
                type="submit"
                className="flex h-14 w-full items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#552285_0%,#8d61ff_100%)] px-6 text-base font-semibold text-white shadow-[0_20px_44px_rgba(103,55,183,0.34)] transition hover:brightness-105"
              >
                Entrar
              </button>
            </form>
