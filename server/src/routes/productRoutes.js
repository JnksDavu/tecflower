...
productRouter.patch('/categories/:id', productController.updateCategory);
productRouter.delete('/categories/:id', productController.removeCategory);
productRouter.post('/tags', productController.createTag);
productRouter.patch('/tags/:id', productController.updateTag);
productRouter.delete('/tags/:id', productController.removeTag);
